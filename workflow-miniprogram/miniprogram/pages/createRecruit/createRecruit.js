...
Page({
  ...
  onLoad: async function (options) {
    try {
      // 获取比赛
      let matches = await util.request('/activity/all/competition?type=fresh', 'GET')
      // 获取团队
  ...
  formSubmit: async function (e) {
    ...
    try {
      await util.request('/recruit/' + this.data.matches[e.detail.value.match].id + '?' + 'teamId=' + this.data.teams[e.detail.value.team].teamId,
        'POST', {
